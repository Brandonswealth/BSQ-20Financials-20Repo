            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600">
                  Choose your service and provide your information to get
                  started
                </p>
              </div>
                    ...
                    <CardContent>
                      <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {formData.preferredPayment === "cashapp" && (
                          <div className="space-y-4 border rounded-lg p-4">
                            <p className="text-sm text-gray-700">
                              Send payment using Cash App. Enter your $Cashtag
                            ...
                            <p className="text-xs text-gray-600">
                              After sending, click Complete Order to finish.
                            </p>
                          </div>
                        )}
                        ...
                        {formData.preferredPayment === "zelle" && (
                          <div className="space-y-3 border rounded-lg p-4">
                            <p className="text-sm text-gray-700">
                              ...
                              . Enter the name that will appear on your Zelle
                              transfer.
                            </p>
                            <div>
                              <Label htmlFor="zelleName">
                                Your Zelle Name *
                              </Label>
                              <Input
                                id="zelleName"
                        ...
                        {formData.preferredPayment === "paypal" && (
                          <div className="space-y-3 border rounded-lg p-4">
                            <p className="text-sm text-gray-700">
                              Pay with PayPal. You’ll be redirected to PayPal to
                        ...
                        {(formData.preferredPayment === "afterpay" ||
                          formData.preferredPayment === "klarna") && (
                          <div className="space-y-3 border rounded-lg p-4">
                            <p className="text-sm text-gray-700">
                              Split payments with{" "}
                              {formData.preferredPayment === "afterpay"
                                ? "Afterpay"
                                : "Klarna"}
                              . We’ll send a secure checkout link to your email
                            ...
                            {paymentPlan === "monthly" &&
                              service.monthlyPrice && (
                                <div className="text-sm text-gray-600 text-right">
                                  Base service total $
                                  {service.price.toLocaleString()} over{" "}
                                  {Math.ceil(
                                    service.price / service.monthlyPrice,
                                  )}{" "}
                                  months. Add-ons billed upfront.
                                </div>
                              )}
                          </div>
