              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Textarea id="help" rows={5} value={formData.help} onChange={(e) => handleInputChange("help", e.target.value)} required placeholder="Tell us what you need help with..." />
                  </div>
                  <Button type="submit" className="w-full bg-gradient-to-r from-brand-blue-light to-brand-blue-dark" disabled={!formData.name || !formData.email || !formData.help}>
                    Send Message
                  </Button>
                </form>
              </CardContent>
            ...
            <div className="space-y-8">
              <Card className="p-8 border-2 border-brand-blue">
                ...
                <CardContent>
                  <div className="space-y-3 mb-6">
                    {["No obligation discussion", "Personalized recommendations", "Expert financial guidance", "Clear next steps"].map((t) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="text-center p-6">
                  ...
                  <CardContent>
                    <p className="text-xl font-bold text-brand-blue mb-1">{PHONE}</p>
                ...
                <Card className="text-center p-6 md:col-span-2">
                  ...
                  <CardContent>
                    <p className="font-semibold text-brand-blue">{ADDRESS_LINE}</p>
                    <p className="text-gray-700">{ADDRESS_CITY}</p>
                    <p className="mt-3 text-gray-700">We also offer move-in ready apartment placements — just ask!</p>
                  </CardContent>
                </Card>
              </div>
            </div>
