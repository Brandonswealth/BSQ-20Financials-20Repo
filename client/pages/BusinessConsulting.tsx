    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-r from-brand-blue-light to-brand-blue-dark text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 text-lg max-w-2xl mx-auto">Strategy, operations, and funding readiness to help you scale.</p>
        </div>
      </section>
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            {["Market and offer positioning","Operational process improvements","Funding and growth roadmap"].map((t)=> (
              <Card key={t} className="p-6">
                <CardHeader>
                  <CardTitle className="text-lg flex items-center"><CheckCircle className="h-5 w-5 text-green-600 mr-2" />{t}</CardTitle>
                  <CardDescription>Practical, measurable outcomes.</CardDescription>
                </CardHeader>
              </Card>
            ))}
          </div>
          <Card className="p-8 text-center">
            <CardContent>
              <p className="text-lg mb-6">Let’s map your next quarter’s priorities.</p>
