      ...
      <section className="bg-gradient-to-r from-brand-blue-light to-brand-blue-dark text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            We believe everyone deserves a fresh start and the right tools to
            grow. Our mission is simple: to help individuals and businesses
            repair, manage, and build financial stability while unlocking
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
              <p className="text-xl mb-8">
                At BSQ Financials, we specialize in personal credit repair,
                business funding, strategic planning, and financial guidance
                designed to meet you exactly where you are today.
              </p>

              <p className="text-lg mb-8">
                Whether you are struggling with personal credit challenges,
                looking to start a business, or aiming to grow an existing one,
                our team works directly with you to create a clear, customized
                path forward. We don't believe in one-size-fits-all solutions.
                Instead, we provide personalized strategies that not only fix
                immediate problems but also position you for future
                opportunities like better loan approvals, business credit, and
                funding access.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">
              What Makes BSQ Financials Different
            </h2>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      We don't just handle your credit or financial needs – we
                      also educate and guide you so you understand the process,
                      the "why" behind every step, and how to maintain long-term
                      financial health.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Every client receives a customized strategy tailored to
                      their unique situation and goals. No cookie-cutter
                      solutions – just personalized guidance that works.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      We focus on building sustainable financial health, not
                      just quick fixes. Our strategies position you for
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We work with clients from all backgrounds, each with unique
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center p-8 hover:shadow-lg transition-shadow">
              <CardHeader className="pb-6">
                ...
                <CardDescription>
                  Seeking personal credit solutions
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  People looking to repair their credit, improve their scores,
                  and gain access to better financial opportunities and loan
                  approvals.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-8 hover:shadow-lg transition-shadow">
              <CardHeader className="pb-6">
                ...
                <CardDescription>
                  Needing start-up funding and structure
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Business founders who need help with business formation,
                  credit building, and securing funding to launch their ventures
                  successfully.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-8 hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Small to medium-sized businesses that want to take things to
                  the next level with strategic financial planning and growth
                  funding.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="prose prose-lg max-w-none text-gray-700 mb-8">
              <p className="text-xl leading-relaxed">
                ...
                BSQ Financials, your future is our priority. Together, we build
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Honest, transparent communication in all our interactions
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Working alongside you as a trusted financial partner
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Focused on delivering measurable financial improvements
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Committed to the highest standards in financial services
              </p>
            </div>
          </div>
        </div>
