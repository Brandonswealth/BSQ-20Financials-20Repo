  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-blue-100">
                Professional credit restoration services designed to improve your credit score 
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">How Credit Repair Works</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Our proven 4-step process to improve your credit score and financial standing
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Complete review of your credit reports from all three bureaus</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Personalized action plan targeting negative items and inaccuracies</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Professional dispute letters sent to creditors and bureaus</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Ongoing monitoring and optimization of your credit profile</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">Choose Your Credit Repair Plan</h2>
            <p className="text-xl text-gray-600">Professional credit restoration packages tailored to your needs</p>
          </div>
              ...
              <CardContent>
                <ul className="space-y-3 mb-6">
                  <li className="flex items-start">
                    ...
                    <span>Complete removal of: Collections, evictions, repossessions, old phone bills, medical debt, student loans</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                    5 premium tradelines
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
          ...
          <Card className="relative border-2 border-gold shadow-xl" style={{borderColor: '#FFD700'}}>
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <Badge className="text-black" style={{backgroundColor: '#FFD700'}}>RECOMMENDED</Badge>
            </div>
            <CardHeader className="text-center pb-6 pt-8">
              <Award className="h-12 w-12 mx-auto mb-4" style={{color: '#FFD700'}} />
              <CardTitle className="text-3xl mb-2">DONE FOR YOU PACKAGE</CardTitle>
              <div className="space-y-2">
                <div className="text-4xl font-bold" style={{color: '#FFD700'}}>$3,997</div>
                <div className="text-lg text-gray-600">or $999/mo x4</div>
              </div>
              <CardDescription className="text-xl">Complete financial transformation - we handle everything</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  <h4 className="font-semibold mb-3 text-brand-blue">Credit Repair Includes:</h4>
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-brand-blue">Bonus Services:</h4>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center">
                      <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">What's Included in Every Plan</h2>
            <p className="text-xl text-gray-600">Comprehensive credit repair services and ongoing support</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Complete review of all credit reports and scores</p>
            </div>

            <div className="text-center">
              <Shield className="h-12 w-12 text-brand-blue mx-auto mb-4" />
              <h3 className="text-lg font-semibold mb-2">Dispute Processing</h3>
              <p className="text-gray-600">Professional dispute letters and follow-up</p>
            </div>

            <div className="text-center">
              <Users className="h-12 w-12 text-brand-blue mx-auto mb-4" />
              <h3 className="text-lg font-semibold mb-2">Expert Support</h3>
              <p className="text-gray-600">Dedicated credit specialists and customer service</p>
            </div>

            <div className="text-center">
              <Clock className="h-12 w-12 text-brand-blue mx-auto mb-4" />
              <h3 className="text-lg font-semibold mb-2">Progress Tracking</h3>
              <p className="text-gray-600">Regular updates and score monitoring</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-brand-blue-light to-brand-blue-dark text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
            Join thousands of satisfied customers who have improved their credit scores with BlueSQ Financials
          </p>
